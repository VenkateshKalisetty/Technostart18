<?php
 ...
 $sql27 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'DevelopersDate'"));
 $sqlResult = mysqli_query($con, "SELECT * FROM eventdetails WHERE eventname = 'DevelopersDate' AND level = 2");
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql27; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/developersdate.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Developers Date Description : </h3>
                            <p>Every Problem is divided into two modules and each module is assigned to two unknown(one boy and one girl). Participants need to solve those problems in their respective dorms within the given period. On the day of event everyone will know their partners and they should solve the complete problem by merging two modules within the given time.  </p>
                            <p style="font-size:22px;color:#000;"><b>Round 1 key : </b><a href="files/DevelopersDateRound1Key.pdf" download>DevelopersDateRound1Key.pdf</a></p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 133">
                                ...
                                <ul>
                                    <li>1. It is a delightful platform for the developers by analyzing the problems and using those skills to solve them</li>
                                    <li>2. This helps in enhancing your technical skills and motivating yourself to code effectively with the new partner.</li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>1. <b>Round 1 : </b>You need to qualify online exam.</li>
                                    <li>2. <b>Round 2 : </b>You need to solve one module in problem statement.</li>
                                </ul>
                            </div>
                            <div class="tab-content-box 130">
                                <h3>Team Constraints to participate</h3>
                                <ul>
                                    <li>1. Come as a single with good skills </li>
                                </ul>
                            </div>
                            <div class="tab-content-box 131">
                                <h3>Evaluation Criteria</h3>
                                <p>In first round there will be a cutoff marks to qualify online exam. In second round marks are based on your choosen technology, Lines of Code, Coding style, etc...,</p>
                            </div>
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. P Nagasiribaba - N120272 - 8499813252</p>
                                <p>2. V Mounika - N120254 - 8501066002</p>
                                <p>3. M.Tarun Kumar - N120275 - 8186947477</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"DevelopersDate"},
