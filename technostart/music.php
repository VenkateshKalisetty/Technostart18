<?php
 ...
 $sql40 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'MusicMasti'"));
 $sqlResult = mysqli_query($con, "SELECT * FROM eventdetails WHERE eventname = 'MusicMasti' AND level = 3");
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql40; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/music.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Music Masti Description : </h3>
                            <p>Life needs enjoyment along with studies. Everyone loves music. Music is the best way to refresh yourself. So, what are you waiting for?..  Let’s be a part of music masthi and enjoy beyond the limits.</p><br>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li><b>Round 1 :-</b><br>Level 1 : Participants need to guess the song based on the tune played.<br>Level 2 : They have to guess the music director name based on the tune played.</li>
                                    <li></li>
                                    <li><b>Round 2 :-</b>Will be intimated on the spot.</li>
                                    <li><b>Round 3 :-</b>Will be intimated on the spot.</li>
                                </ul>
                            </div>
                            <div class="tab-content-box 130">
                                <h3>Team Constraints to participate</h3>
                                <ul>
                                    <li>1. Team should contain 4 members</li>
                                </ul>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"MusicMasti"},
