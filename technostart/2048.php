<?php
 ...
 $count2048 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = '2048'"));
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $count2048; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/2048.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>2048 Description : </h3>
                            <p>It's a type of “sliding block puzzle” — think Threes!, on which 2048 is based, or the old-timey game klotski — that's played on an almost Sudoku-like grid. Like Sudoku, it also involves some math. The object of the game is to combine the numbers displayed on the tiles until you reach 2048.</p><br>
                            <p style="font-size:22px;font-weight:bold;">Only for Girls</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>Time limit will be given.</li>
                            ...
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>Team Technostart 2k18 v5.0</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"2048"},
