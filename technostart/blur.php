<?php
 ...
 $blurcount = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'Blur'"));
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $blurcount; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/blur.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Blur Description : </h3>
                            <p>Blur is an arcade racing video game. It features a racing style that incorporates real world cars and locales with arcade style handling and vehicular combat. Blur have it's own racing styles, power-up set ups, match types,and cars.each match that determine the layout of power-ups, car classes, amount of laps, and the track to race.</p><br>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li><b>Round 1 : </b>Map Name : Brighton<br>Laps : 4 Laps<br>Car selection : Same as Host<br>Car Class : any<br>Game Mode : Powerup Racing<br><b>Note : </b>Top 3 Racers are allowed to Next Round</li>
                                    <li><b>Round 2(Finals) : </b>Map Name : Hollywood Hills<br>Laps : 4 Laps<br>Car selection : Racer Wish<br>Car Class : "A" <br>Game Mode : Powerup Racing</li>
                                    <li>1. Everyone Come along with their own laptop with any Version of Windows Operating System,Blur game, Lancable and Adaptor.<br>2. Rules Maybe Changed Depends on Number of Participants and Time. </li>
                                </ul>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"Blur"},
