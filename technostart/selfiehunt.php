<?php
 ...
 $sql17 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'SelfieHunt'"));
 $sqlResult = mysqli_query($con, "SELECT * FROM eventdetails WHERE eventname = 'SelfieHunt' AND level = 2");
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql17; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/selfiehunt.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Selfiehunt Description : </h3>
                            <p>A trending thing for everyone with their “SMART PHONE".<br>
                                If you love the location ,what will you do………?????????
                                How CRAZY  you are in CLICKING SELFIES….???????
                                Are you crazy in taking selfiessss….??????????????
                                If so,come and explore your craziness and make others damn CRAZYYYYY
It’s a Crazy……..Crazy…..Crazy……Crazy…..Clicking</p><br>
                            <p style="font-size:22px;color:#000;"><b>Round 1 key : </b><a href="files/SelfieHuntRound1Key.zip" download>SelfieHuntRound1Key.zip</a></p>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>1. <b>Round 1 : </b>How efficient your brains search engine optimizes(SEO).</li>
                                    <li>2. <b>Round 2 : </b>How your brain COMPILES and EXECUTES the challenge.</li>
                                </ul>
                            ...
                            <div class="tab-content-box 130">
                                ...
                                <ul>
                                    <li>1. Each team should contain maximum 2 members.</li>
                                </ul>
                            </div>
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. Y Naga Aravind - N120074 - 9618413537</p>
                                <p>2. L Srija - N120630 - </p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"SelfieHunt"},
