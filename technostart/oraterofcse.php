<?php
 ...
 $sql23 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'OratorofCSE'"));
 $sqlResult = mysqli_query($con, "SELECT * FROM eventdetails WHERE eventname = 'OratorofCSE' AND level = 3");
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql23; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/orator.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Orator of CSE Description : </h3>
                            <p>“Knowledge is of no value unless you put it into practice and the best practice is speaking..!! Speak out to spread your knowledge..!! Here comes the golden opportunity to show case your oratory skills!</p>
                            <p style="font-size:20px;"><b>“You don’t have to be great to start but you have to start to be great”</b></p><br>
                            <p>Expecting your enthusiastic participation to make this event memorable..!!</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="row tab-row">
                        <div class="col-lg-5 col-md-5">
                            <ul class="tab-title">
                                <li><span data-tab-name="134" class="hvr-bounce-to-right active">Rules and Regulations</span></li>
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 133">
                                ...
                                <ul>
                                    <li>1. Individual participants</li>
                                    <li>2. Consists of three rounds</li>
                                    <li>3. Round 1: Group discussion</li>
                                    <li>4. Round 2: Debate</li>
                                    <li>5. Round 3: just a minute</li>
                                    <li>6. Preferable language English</li>
                                    <li>7. Topic will be given on the spot</li>
                                    <li>8. Judges decision will be final</li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. N120306 - Md. Fathima gousiya - 8500812668</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"OratorofCSE"},
