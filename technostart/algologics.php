<?php
 ...
 $sql29 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'AlgoLogics'"));
 $sqlResult = mysqli_query($con, "SELECT * FROM eventdetails WHERE eventname = 'AlgoLogics' AND level = 2");
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql29; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/algo.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>AlgoLogics Description : </h3>
                            <p>If you think AlgoLogics is all about Algorithms<br>Then we print "You are wrong"<br>
                            We have our own brain and body, Let's use the first one.<br>
                            Logic is principle that guide reasoning within a given field or situation. Every logical problem will have way to be solved which is called algorithm. Together AlgoLogics will test your problem solving ability in a series of steps. This is a perfect choice for those who like to solve mathematical and logical puzzles as well as design algorithms regardless of any programming knowledge.</p><br>
                            <p style="font-size:22px;color:#000;"><b>Round 1 key : </b><a href="files/ALGO-LOGICS_Round1_Paper_key.pdf" download>ALGO-LOGICS_Round1_Paper_key.pdf</a></p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 133">
                                ...
                                <ul>
                                    <li>1. Helpful in competitive Events.</li>
                                    <li>2. Expect Fun.</li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>1. <b>Round 1 : </b>Simple Logical Questions for screening[15 Questions 30min]</li>
                            ...
                            <div class="tab-content-box 130">
                                ...
                                <p>(Students from E1,E2,E3 are suggested to be a team)</p>
                            </div>
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. Krishna Mahesh - N120508 - 9494253812</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"AlgoLogics"},
