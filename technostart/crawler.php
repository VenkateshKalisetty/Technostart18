<?php
 ...
 $sql31 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'Crawler'"));
 $sqlResult = mysqli_query($con, "SELECT * FROM eventdetails WHERE eventname = 'Crawler' AND level = 2");
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql31; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/crawler.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Crawler Description : </h3>
                            <p>In this tech savvy generation, GOOGLE has become the answer to all our problems. So we have come up with a fun, exciting and logical game called “Crawler”.<br><br><b>If you have what it takes to be a top in spidering… <br>Come ,Participate and have fun!!!!<br>Happy googling!!!!</b></p><br>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>1. <b>Round 1 : </b>The participant would be given a set of questions, the answer to has to be searched on internet. The type of questions include puzzles, current affairs, logical questions etc.</li>
                                    <li>2. <b>Round 2 : </b>Surfing level will increase.</li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. Allu Appalanaidu - N110992 - 7013462426</p>
                                <p>2. K.Sravani - N120408 - 9398668208</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"Crawler"},
