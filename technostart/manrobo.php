<?php
 ...
 $sql32 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'MannualRobotics'"));
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1>Mannual Robotics</h1>
                </div>
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql32; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/manualrobo.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Mannual Robotics Description : </h3>
                            <p>Students have to build a manually controlled robot that is capabale of completing all the checkpoints. The robots are allowed to pass through a series of checkpoints.The checkpoints may be like terrians , sand , pebbles , mud etc...The robot which crossed maximum checkpoints sucessfully will gain more points.</p><br>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 133">
                                ...
                                <ul>
                                    <li>During the Rounds, only maximum of two members are allowed in the arena, One member will control the robot and other to guide it.</li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. Y.Raju - N120945 - 8096528221</p>
                                <p>2. U.Praveen Kumar - N120957 - 7013300587</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"MannualRobotics"},
