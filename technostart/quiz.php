<?php
 ...
 $sql22 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'Quiz'"));
 $sqlResult = mysqli_query($con, "SELECT * FROM eventdetails WHERE eventname = 'Quiz' AND level = 3");
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql22; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/quiz.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Quiz Description : </h3>
                            <p>It is also important to know the world (includes all the non-technical stuff) apart from your technical world. Here’s a platform for you people to know how much extent you can able to answer about that non-technical world. Join the Quiz and test yourselves. Let’s have a serious participation and some fun too.</p><br>
                            <p style="font-size:22px;color:#000;"><b>Round 1 key : </b><a href="files/NonTechnicalQuizKey.pdf" download>NonTechnicalQuizKey.pdf</a></p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>1. <b>Round 1 : </b>25 Multiple Choice Questions with 30 min time limit., No negative marking, Each question carry 1 Mark,</li>
                                    <li>2. <b>Round 2 : </b>Spot Intimation.</li>
                            ...
                            <div class="tab-content-box 132">
                                ...
                                <p>2. M Ashok Babu - N120891 - 8142683036</p>
                                <p>3. Ch Satya Suma Sri - N120784 - 8008586855</p>
                                <p>4. Sk Shabana - N120783 - 9848235050</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"Quiz"},
