<?php
 ...
 $sql11 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'CodeMarathon'"));
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql11; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/codemarthon.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Code Marathon Description : </h3>
                            <p>Are you a guy interested in coding at night time then this event is for you.This is the event to showcase your coding talent infront of us. </p><br>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 133">
                                ...
                                <ul>
                                    <li>1. This is very challenging event which is conducted for 12 hours, only 6 problems you need to solve with your gang to prove your coding and problem solving skills. I’m sure you can solve every problem because they are very simple to solve. Register with your gang and get ready to hunt the night. This certificate more weightage to your resume.</li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>1. This is Night hunt competition.</li>
                                    <li>2. Team size at most 3 members</li>
                                    <li>3. Time given : 12hours (10pm – 10am)</li>
                                    <li>4. You can code in any language as your choice.</li>
                                    <li>5. Problems will be notified through Technostart-2k18 v5.0 website.</li>
                                </ul>
                            </div>
                            <div class="tab-content-box 131">
                                <h3>Evaluation Criteria</h3>
                                <p>Based on your submission time, Logic, Chosen language, etc...,</p>
                            </div>
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. CHALAPATHI NAYAK - N120711 - 9000510095</p>
                                <p>2. MASTHANA - N120869 - 9666891408</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"CodeMarathon"},
