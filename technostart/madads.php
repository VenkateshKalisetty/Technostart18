<?php
 ...
 $sql37 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'MadAds'"));
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql37; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/madads.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Mad Ads Description : </h3>
                            <p>This is also an entertaining event. This event is based on the Direction skills within you. In this event you have to do publicity of any product (of your interest) in the market with an Advertisements. You can do advertisements with people, things etc.. anything based on your product. And record/shoot that video and edit as per your requirement and upload to us on befor the deadline given.</p><br>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>1. Advertisements can be only between 1 to 3 min long.</li>
                                    <li>2. No Vulgarity words should use.</li>
                                    <li>3. Product can be anything as per your interest.</li>
                                    <li>4. Size of team for this event can be as per your requirement</li>
                                    <li>5. You have to submit your Mad Ads before mentioned time.<b>But register only one member</b></li>
                                </ul>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"MadAds"},
