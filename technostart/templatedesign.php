<?php
 ...
 $sql13 = mysqli_num_rows(mysqli_query($con, "SELECT eventname FROM eventdetails WHERE eventname = 'TemplateDesign'"));
?>
    <!-- #Event title -->
    <section id="page-title" class="gradient-overlay">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <h1 style="font-size:28px;">Registered Teams : <?php echo $sql13; ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row text-row">
                        <div class="col-lg-6 col-md-6">
                            <img width="560" height="348" src="assets/images/event/templatedesign.jpg" class="wow slideInLeft wp-post-image" alt="about-banner" />
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <h3>Template Design Description : </h3>
                            <p> A template Desiging is a creativity of design solutions with high visual impact, which are required in number of products and activities like books, magazine, exhibitions, computer games, websites and a lot more. A designer must understand his/her clients need before beginning or deciding the work. Graphic design work requires top creativity, being up-to-date with software and also time or the deadlines.are you guy like that then this event belongs to you. </p><br>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row tab-row">
                        ...
                        <div class="col-lg-7 col-md-7 wow bounceInRight">
                            <div class="tab-content-box 134">
                                ...
                                <ul>
                                    <li>2. <b>Round 1 : </b>We will give you a theme, you have to design and submit within the given period.</li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content-box 131">
                                ...
                                <p>The second round evaluation will based on your designing skills and programming style.</p>
                            </div>
                            <div class="tab-content-box 132">
                                <h3>Co-Ordinators</h3>
                                <p>1. A.Kavitha - N120968 - 7095444315</p>
                            </div>
...
<script>
    ...
    function add(){
        ...
        $.ajax({
            ...
            method:"post",
            data:{"new_team":$team,"event_name":"TemplateDesign"},
